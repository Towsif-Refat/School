...
document.getElementById("errname").innerHTML = "";
  ...
  function checkDob(){
  	var dt=document.Reg_Form.dob.value;
  	var date_regex = /^(0[1-9]|1[0-2])\/(0[1-9]|1\d|2\d|3[01])\/(19|20)\d{2}$/;
	if (!(date_regex.test(testDate))) {
		
		  document.getElementById("errdob").innerHTML = "Date not valid";
	    return false;
	}
...
document.getElementById("errcpass").innerHTML = "";
  ...
  // }
    ...
    if(pass.length<8){
      ...
      //   document.getElementById("ename").innerHTML = "Password is required!!";
      //   return false;
      // }
      // else if(!passRegex.test(pass))
      // {
      //   document.Reg_Form.pass.focus();
      //   document.getElementById("ename").innerHTML = "Your Password Must Contain At Least one uppercase, lowercase letter and special character!";
      //   return false;
      // }
      //CPassword
      if(cpass == "")
